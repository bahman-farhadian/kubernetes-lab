...
**Status:** Not started. Per the [rollout plan](../../README.md#rollout-plan), this profile is built only after **Light** (`../../1-light-laptop/stacked-etcd/`) has been deployed and validated end to end, including the upgrade exercise in its `16-day2-operations.md`.

## How to build this out

The procedure is the same as `1-light-laptop/stacked-etcd/` — same steps, same commands, same package-hold discipline — because the hardware shape is the same (bastion, 3 control-plane, 3 workers), just bigger. When you're ready:

1. Copy every file from `../../1-light-laptop/stacked-etcd/` into this directory.
