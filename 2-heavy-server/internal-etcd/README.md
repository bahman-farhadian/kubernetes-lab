...
The procedure is the same as `1-light-laptop/internal-etcd/` — same steps, same commands, same package-hold discipline — because the hardware shape is the same (bastion, 3 control-plane, 3 workers), just bigger. When you're ready:

1. Copy every file from `../../1-light-laptop/internal-etcd/` into this directory.
