...
**1. `node_exporter` on every node** — bastion, control-plane, etcd, workers, and `k8s-monitor` itself, same pinned version everywhere:
```sh
sudo apt update
  ...
  - job_name: node
    static_configs:
      - targets:
          ...
          - 10.0.1.15:9100   # k8s-etcd-1
          - 10.0.1.16:9100   # k8s-etcd-2
          - 10.0.1.17:9100   # k8s-etcd-3
