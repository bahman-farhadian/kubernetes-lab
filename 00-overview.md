...
| CNI | Calico (NetworkPolicy support, needed in each directory's `15-security-hardening.md`, e.g. [1-light-laptop/stacked-etcd/15-security-hardening.md](1-light-laptop/stacked-etcd/15-security-hardening.md)) |
